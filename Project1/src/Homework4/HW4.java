...
public class HW4 {
        ...
        public static List<String> correctedList(List<String> stringList) {
            ...
            List<String> stringListnoup = new ArrayList<>();
            for (String str : stringList) {
                ...
                if (!hasUppercase) {
                    stringListnoup.add(str);
                }
            }
            return stringListnoup;
            //return stringList;
        }
        ...
        public static class AntiCheat {
            public static void run() {
                ...
                antiCheatList.addAll(HW4.setMagazine().keySet().stream().map(Object::toString).toList());
                antiCheatList.addAll(HW4.setlungsCheck().values().stream().map(Object::toString).toList());
